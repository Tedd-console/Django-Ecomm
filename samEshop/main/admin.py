...
from .models import Category, Color, Brand, Size, Product, ProductAttribute, Banner, CartOrder, CartOrderItems, \
...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('id', 'title', 'brand', 'category', 'color', 'size', 'status', 'is_featured')
